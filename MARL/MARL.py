...
class Agent:
    def __init__(self, client, n_actions, policy, BATCH_SIZE=128, GAMMA=0.999, EPS_START=0.9, EPS_END=0.05, EPS_DECAY=200, TARGET_UPDATE=10):
        self.client = client
    ...
    ## epsilon greedy
    def select_action(self, state, policy_net, target_net):
